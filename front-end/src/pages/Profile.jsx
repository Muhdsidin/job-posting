      ...
      <div className="max-w-4xl mx-auto bg-blue-800 mt-12 p-8 rounded-lg shadow-lg">
        ...
        <div className="mb-6">
          ...
          <div className="flex flex-wrap gap-3">
            <span className="bg-blue-600 px-4 py-2 rounded-full text-white">React</span>
            <span className="bg-blue-600 px-4 py-2 rounded-full text-white">Node.js</span>
            <span className="bg-blue-600 px-4 py-2 rounded-full text-white">Next.js</span>
            <span className="bg-blue-600 px-4 py-2 rounded-full text-white">Tailwind CSS</span>
            <span className="bg-blue-600 px-4 py-2 rounded-full text-white">GraphQL</span>
          </div>
        </div>
